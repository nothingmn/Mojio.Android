...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor> {
    ...
    public static final String MOJIO_CLIENT_ID = "mojioClient_id";
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                //Thread.sleep(2000);
                mojio.Login(mEmail, mPassword, new JsonHttpResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, org.apache.http.Header[] headers, JSONObject response) {
                        ...
                        Intent listIntent = new Intent(activity, VehicleListActivity.class);
                        listIntent.putExtra(MOJIO_CLIENT_ID, mojio.getMojioAPIToken());
            ...
            for (String credential : DUMMY_CREDENTIALS) {
                ...
                if (pieces[0].equals(mEmail)) {
                    ...
                    loginSuccess= pieces[1].equals(mPassword);
                }
            }
